...
def scan_length_fs_shap_topx(odir):
    o=open(odir+'/longest_len_fs_shap_topx.txt','w+')
    o.write('Graph\tPC\tKmer\n')
    ls1=cal_len(odir+'/strains_train_sentence_fs_shap_filter_top100.txt',odir+'/strains_test_sentence_fs_shap_filter_top100.txt')
    ls2=cal_len(odir+'/strains_train_pc_token_fs_shap_filter_top100.txt',odir+'/strains_test_pc_token_fs_shap_filter_top100.txt')
    ls3=cal_len(odir+'/strains_train_kmer_token_shap_filter_top100.txt',odir+'/strains_test_kmer_token_shap_filter_top100.txt')
    o.write(str(ls1)+'\t'+str(ls2)+'\t'+str(ls3)+'\n')
