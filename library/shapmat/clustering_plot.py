...
def plot_cluster(CRC_cluster_df,n_cluster,figsize=(10,10),title=None,savefig=False,output_path=None):
    ...
    scatter = plt.scatter(CRC_cluster_df['PC1'],CRC_cluster_df['PC2'],
                        s=200,c=CRC_cluster_df['cluster'],cmap=cmap,alpha=0.9,edgecolors='black') 
        
    handles,labels = scatter.legend_elements()
    legend = plt.legend(handles,labels,fontsize=25,loc='best',markerscale=2.5) #,bbox_to_anchor = (1.2, 1.03)
